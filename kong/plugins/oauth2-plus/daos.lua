...
local OAUTH2_AUTHORIZATION_CODES_SCHEMA = {
  primary_key = {"id"},
  table = "oauth2p_authorization_codes",
  fields = {
    id = { type = "id", dao_insert_value = true },
...
return {
  oauth2p_credentials = OAUTH2_CREDENTIALS_SCHEMA,
  oauth2p_authorization_codes = OAUTH2_AUTHORIZATION_CODES_SCHEMA,
  oauth2p_tokens = OAUTH2_TOKENS_SCHEMA
}
